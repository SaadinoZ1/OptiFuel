...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CommissionContact", b =>
                {
                    ...
                    b.HasKey("CommissionId", "ContactId");

                    b.HasIndex("ContactId");

                    b.ToTable("CommissionContact");
                });
            ...
            modelBuilder.Entity("CommissionContact", b =>
                {
                    b.HasOne("OptiFuel.Models.Commission", null)
                        .WithMany()
                        .HasForeignKey("CommissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OptiFuel.Models.Contact", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OptiFuel.Models.Commission", b =>
                {
                    b.HasOne("OptiFuel.Models.ValidationBL", "ValidationBL")
                        .WithOne("Commission")
                        .HasForeignKey("OptiFuel.Models.Commission", "ValidationBLId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
